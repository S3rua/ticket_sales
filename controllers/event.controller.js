/**memuat model buat tabel event*/
const eventModel = require('../models').event
/**memuat operasi sequelize */
const Op = require('sequelize').Op  

/** memuat pustaka 'path' dan filestream */
const path = require('path')
const fs = require('fs')

/**buat fungsi buat baca semua data */
exports.getAllEvent = async (request,response) => {
/**manggil findAll() buat mengambil semua data */
